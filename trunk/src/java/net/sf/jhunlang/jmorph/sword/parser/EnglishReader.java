 ...
 */
public class EnglishReader extends DictionaryReader
{
  /**
  ...
  {
    return derivatives.contains(morph);
  }
    ...
    throws ParseException
  {
    ...
    if (st.hasMoreTokens())
    {
      ...
      EnglishEntryExtensionParser extParser =
        new EnglishEntryExtensionParser(ext);
